...
#if defined(NDEBUG)
# error "Xephula cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0x73e1d4386fa9aa381e5fd3483fb89a37127c0933492c12cf83ebe0aa290533c8");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Xephula: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Xephula Signed Message:\n";
...
{
    // Xephula: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Xephula: 3.5 days
static const int64 nTargetSpacing = 3 * 60; // Xephula: 3 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Xephula: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Xephula: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x73e1d4386fa9aa381e5fd3483fb89a37127c0933492c12cf83ebe0aa290533c8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04d70dbe5c3d253552250298c9a3aced0f1930b41816abdbe0d9cd00ec6897a82f5874466eab67c593a7c33eb036e35299a4648f0753b5f986903c985263edbc82") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1618139619;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084616442;
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x57f781be016f385d43bbd1917b6a2459a1393c421700bcc1e025a5a554ee6393"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc3, 0xba, 0xd3 }; // Xephula: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("XephulaMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("XephulaMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static XephulaMiner(CWallet *pwallet)
{
    printf("XephulaMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("xephula-miner");
    ...
    try { loop {
        ...
        printf("Running XephulaMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("XephulaMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&XephulaMiner, pwallet));
}
