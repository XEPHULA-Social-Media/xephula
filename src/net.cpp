...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Xephula " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"xephulatools.com", "dnsseed.xephulatools.com"},
    {"xephulapool.org", "dnsseed.xephulapool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"xephulatools.com", "testnet-seed.xephulatools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Xephula is probably already running."), addrBind.ToString().c_str());
        else
